...
\author{\href{https://github.com/Harsha081459/-Question-Answering-System-with-a-Custom-Transformer-Encoder-and-Generative-Decoder}{\textbf{[GitHub]}} \quad $\mid$ \quad \href{https://iiitbac-my.sharepoint.com/:f:/g/personal/vishal_sriram_iiitb_ac_in/IgBJMBmHEodfQba6fYpup9aiAdhsUH577v5oWa_W0i20VqM?e=j7DCc6}{\textbf{[Weights -- OneDrive]}}}
\date{}
...
\rowcolor{gray!8}
 & Inference & beam search, max 32 tokens, lp 1.0 \\
\bottomrule
\end{tabularx}
\end{table}
...
The generative track demonstrated the strength of our bespoke decoder. Evaluated on the full validation set, our custom decoder achieved an F1 of 39.9, outperforming Flan-T5-small (32.0) and T5-small (38.1), and closely trailing the much larger T5-base (42.1).

\begin{table}[H]
\centering
\scriptsize
\caption{Generative QA comparison on the full validation set.}
\begin{tabular}{@{}lcccc@{}}
\toprule
...
\caption{Generative QA F1 on the full validation set. Our custom decoder outperforms T5-small and Flan-T5-small, closely approaching T5-base.}
\end{figure}
...
\centering
\scriptsize
\caption{Ablation: effect of no-answer upweighting ($3\times$) on the full validation set.}
\begin{tabular}{@{}lcccc@{}}
\toprule
